...
class VehicleCoordinator():
    ...
    def __init__(self):
        ...
        rospy.Subscriber('/duckiebot0/new_joy_mapper_node/letsgo', BoolStamped, self.letsgo_callback)
    ...
    def letsgo_callback(self, msg):
        if msg.data == True:
            if self.state == State.TL_SENSING:
    ...
    def publish_topics(self):
        ...
        if (self.clearance_to_go == CoordinationClearance.GO):
            ...
            rospy.Timer(rospy.Duration.from_sec(0.5), self.cbForward, oneshot=True)
